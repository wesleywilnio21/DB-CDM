...
use App\Http\Controllers\EventLetterController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/settings/organization', [OrganizationSettingController::class, 'update'])->name('settings.organization.update');

    Route::resource('letter-assets', LetterAssetController::class)->only(['index', 'store', 'destroy']);
    ...
    Route::get('events/{event}/letters/bulk-generate', [EventLetterController::class, 'bulkGenerate'])->name('letters.bulk-generate');
    Route::post('events/{event}/letters/bulk-store', [EventLetterController::class, 'bulkStore'])->name('letters.bulk-store');
    Route::resource('events/{event}/letters', EventLetterController::class)->except(['show', 'create', 'store']);
    Route::get('letters/{letter}/pdf', [EventLetterController::class, 'exportPdf'])->name('letters.pdf');
    ...
    Route::resource('donation-sessions', DonationSessionController::class);
    Route::post('donation-sessions/{donation_session}/add-donor', [DonationSessionController::class, 'addDonor'])->name('donation-sessions.add-donor');
    Route::post('donation-sessions/{donation_session}/create-donor', [DonationSessionController::class, 'createAndAddDonor'])->name('donation-sessions.create-donor');
    Route::delete('donation-sessions/{donation_session}/remove-donor/{donor}', [DonationSessionController::class, 'removeDonor'])->name('donation-sessions.remove-donor');
