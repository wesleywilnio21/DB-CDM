<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_current_password" :value="__('Current Password')" class="text-gray-900 font-bold" />
        ...
        <div>
            <x-input-label for="update_password_password" :value="__('New Password')" class="text-gray-900 font-bold" />
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('Confirm Password')" class="text-gray-900 font-bold" />
